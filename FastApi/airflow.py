...
def airflow_dag_trigger(param):
    try:
        ...
        response = requests.post('http://host.docker.internal:8080/api/v1/dags/verify_pdf_v1/dagRuns',headers = header, json = json.loads(param.json()), auth=('airflow', 'airflow'))
